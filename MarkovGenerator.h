...
class MarkovGenerator final : public unit_generator<T>, protected vessl::plist<0>
{
public:
...
public:
  explicit MarkovGenerator(vessl::size_t memorySize) : unit_generator<T>(), markovChain(memorySize) {}
