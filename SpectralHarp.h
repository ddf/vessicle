...
class SpectralHarp : public vessl::unit_generator<float>, vessl::plist<4>
{
public:
  ...
  SpectralHarp(SpectralGen* spec_gen, float sample_rate, size_t bands_size,
  ...
  static SpectralHarp* create(float sample_rate)
  {
    ...
    return new SpectralHarp(spectral_gen, sample_rate, bands_max, bands_data, bright_data, spread_data);
  }

  static void destroy(SpectralHarp* synth)
  {
